...
contract PlonkVerifier9 {
    ...
    uint16 constant nPublic   = 13;
    uint16 constant nLagrange = 13;
    
    uint256 constant Qmx  = 3461794031796127798159087300838697388040361480628931144441466876209970712768;
    uint256 constant Qmy  = 2306388928824813124556419607158248403071895835593917522335002846100581751153;
    uint256 constant Qlx  = 3601195166928941367253899208042742776705507184957048119414959358384403933294;
    uint256 constant Qly  = 14149222879734836075700499562034765976268885155537165176925074169655933828374;
    uint256 constant Qrx  = 1960855274041838693008335734865823678640851904996318742316501614219888540101;
    uint256 constant Qry  = 3708986560705056266931325270604638558282963872244436019912408534552504577462;
    uint256 constant Qox  = 17455455884684960426765377208458485537868654793585777749208757611498111321867;
    uint256 constant Qoy  = 18340805938031145586806381144717132785334900314667086317942946780137486505498;
    uint256 constant Qcx  = 20234570618441899101826077554605777882925129675065177790201013661192852630519;
    uint256 constant Qcy  = 9993418249911466682147585299333091136666283300961627708158830892004293199271;
    uint256 constant S1x  = 7891066636864547936978414856127077826372525476583295987751983284019985712997;
    uint256 constant S1y  = 12871949022401619931116176104931990311220445980003471001274985753173144961549;
    uint256 constant S2x  = 4833259851344757328416920711427919736637058770962465664376924618457177777369;
    uint256 constant S2y  = 2143680435964601723878513338134793972295397702686232676366211978241544089093;
    uint256 constant S3x  = 5106000051282095115552868764445154579783263831819920125308383343778224187919;
    uint256 constant S3y  = 2811139402911841196946203465307256492643297861150193176751355547224276193440;
    uint256 constant k1   = 2;
    uint256 constant k2   = 3;
    uint256 constant X2x1 = 8035689742411694987326877984658914032020923620243136169288753416740390733048;
    uint256 constant X2x2 = 10398946017852333028667641468059563362633366467459485167101398858956904409080;
    uint256 constant X2y1 = 6695815266100835941451056448562989029932722497124076623487075991591404676603;
    uint256 constant X2y2 = 2633382677210964721645679859921606623085722363246431629523712062869980926749;
    ...
    function verifyProof(uint256[24] calldata _proof, uint256[13] calldata _pubSignals) public view returns (bool) {
        assembly {
            /////////
            ...
            function calculateChallenges(pMem, pPublic) {
                ...
                mstore(add(mIn, 928 ), calldataload(pA))
                mstore(add(mIn, 960 ), calldataload(add(pA, 32)))
                mstore(add(mIn, 992 ), calldataload(pB))
                mstore(add(mIn, 1024 ), calldataload(add(pB, 32)))
                mstore(add(mIn, 1056 ), calldataload(pC))
                mstore(add(mIn, 1088 ), calldataload(add(pC, 32)))
                
                beta := mod(keccak256(mIn, 1120), q) 
            ...
            function calculateLagrange(pMem) {
                ...
                inverseArray(add(pMem, pZhInv), 14 )
