...
contract PlonkVerifier11 {
    ...
    uint256 constant Qmx  = 7706468467186848254022654254652482920010654179164394535605398264815060476932;
    uint256 constant Qmy  = 13161174770460658649543883505092771819752245028592617520150259619708909246208;
    uint256 constant Qlx  = 2588868476442348662143571817555265912431343799912253545663998272573830892848;
    uint256 constant Qly  = 19907035318897614111650584395225800536223704114402385004302507259919033091799;
    uint256 constant Qrx  = 20867021772472759729270938300233098008057627065678553463813279284214494543513;
    uint256 constant Qry  = 9410496584943680201939229658700281545726339903984237522653554086977691755171;
    uint256 constant Qox  = 15913088590186477178654151450320270680078937314206725699334875504070973737866;
    uint256 constant Qoy  = 20065465972899320024217206337481592305876531644264316411911452672490947043944;
    uint256 constant Qcx  = 2992068744988603520433753166176545062629239027951631122892461958081977566891;
    uint256 constant Qcy  = 13643771308755854286200820073114971747959661500147131465471387064754085222400;
    uint256 constant S1x  = 4279369519184817793634896133338521007090905650079530404455337359777189567720;
    uint256 constant S1y  = 14309298721206126068421763125963007458373681237146475048342905767441632902185;
    uint256 constant S2x  = 4332856526942837947555471275124720744513849585037089644360499734322455126934;
    uint256 constant S2y  = 59826624462374807353392118862986592334640620173619809337588739193427070912;
    uint256 constant S3x  = 5182006369079744091004618228297713991762478004712649618039552463838614856596;
    uint256 constant S3y  = 12267291657260438596862346579819521222272354683689368218947185716866623012661;
    ...
    uint16 constant lastMem = 1280;

    function verifyProof(uint256[24] calldata _proof, uint256[15] calldata _pubSignals) public view returns (bool) {
        assembly {
            /////////
            ...
            function calculateChallenges(pMem, pPublic) {
                ...
                mstore(add(mIn, 992 ), calldataload(pA))
                mstore(add(mIn, 1024 ), calldataload(add(pA, 32)))
                mstore(add(mIn, 1056 ), calldataload(pB))
                mstore(add(mIn, 1088 ), calldataload(add(pB, 32)))
                mstore(add(mIn, 1120 ), calldataload(pC))
                mstore(add(mIn, 1152 ), calldataload(add(pC, 32)))
                
                beta := mod(keccak256(mIn, 1184), q) 
